...
* Add tests for:
** <code>OTP_TOKEN</code>
** <code>run_appropriately</code>
** multiple keys and OTP-tokens in an hash
** All OATH implementations we support:
*** "Google Authenticator PAM module":https://code.google.com/p/google-authenticator/
*** "pam_oath":http://www.nongnu.org/oath-toolkit/
